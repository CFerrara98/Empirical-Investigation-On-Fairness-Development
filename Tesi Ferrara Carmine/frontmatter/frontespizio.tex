...
\begin{center}
\includegraphics [width=.15\columnwidth, angle=0]{figure/unisa.pdf}\\ % height
\vspace{0.5cm}
...
\vspace{3cm}
{\Huge \bfseries \begin{nointerlinea}{1}Machine Learning Fairness:\\ un'analisi empirica\\ dello stato della pratica\\\end{nointerlinea}} 
\vspace{5cm}
